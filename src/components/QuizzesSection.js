...
function QuizzesSection(props) {
  ...
  const getQuizInfo = async (id) => {
    ...
    let url = `https://mcqpsm.online/quiz/${id}`;
  ...
  const handleJoinSubmit = async () => {
    ...
    setQuizCodeError(false);
    setEnrollSnack(true);
    let url = 'https://mcqpsm.online/quiz/enrollPrivate';
    let token = localStorage.getItem('authToken');
  ...
  const handleEnroll = async () => {
    setEnrollSnack(true);
    let token = localStorage.getItem('authToken');
    let url = 'https://mcqpsm.online/quiz/enroll';
  ...
  const handleUnenroll = async () => {
    setEnrollSnack(true);
    let token = localStorage.getItem('authToken');
    let url = 'https://mcqpsm.online/quiz/unenroll';
  ...
  const handleQuizStart = async () => {
    setEnrollSnack(true);
    let token = localStorage.getItem('authToken');
    let url = `https://mcqpsm.online/quiz/start`;
  ...
  const getQuizzes = async () => {
    setLoading(true);
    let token = localStorage.getItem('authToken');
    let url = 'https://mcqpsm.online/quiz/all';
