...
function EditQuiz(props) {
  ...
  const submitCSV = async (questions) => {
    ...
    let url = 'https://mcqpsm.online/question/csv';
  ...
  const handleRestart = async () => {
    let token = localStorage.getItem('authToken');
    let url = `https://mcqpsm.online/quiz/restart`;
  ...
  const handleQuizClose = async () => {
    let token = localStorage.getItem('authToken');
    let url = `https://mcqpsm.online/quiz/close`;
  ...
  const handleDeleteQuestion = async () => {
    let token = localStorage.getItem('authToken');
    let url = `https://mcqpsm.online/question/${updateId}`;
  ...
  const handleQuestionUpdate = async () => {
    ...
    let token = localStorage.getItem('authToken');
    let url = `https://mcqpsm.online/question/update/${updateId}`;
  ...
  const handleQuestionSubmit = async () => {
    ...
    let token = localStorage.getItem('authToken');
    let url = `https://mcqpsm.online/question/add`;
  ...
  const isOwnerOfQuiz = async () => {
    let token = localStorage.getItem('authToken');
    let url = `https://mcqpsm.online/quiz/checkAdmin/${quizId}`;
  ...
  const getQuizDetails = async () => {
    setLoading(true);
    let token = localStorage.getItem('authToken');
    let url = `https://mcqpsm.online/quiz/${quizId}`;
    ...
    url = `https://mcqpsm.online/question/all/${quizId}`;
    ...
    url = `https://mcqpsm.online/admin/allStudentsQuizResult/${quizId}`;
